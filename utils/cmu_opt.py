...
class Options:
    ...
    def _initial(self):
        ...
        self.parser.add_argument('--data_dir', type=str,
                                 default='/data/user/gbx/data/cmu_mocap',
        ...
        self.parser.add_argument('--ckpt', type=str, default='checkpoint/CMU', help='path to save checkpoint')
        ...
        self.parser.add_argument('--node_n', type=int, default=75, help='number of GCN nodes')
        ...
        self.parser.add_argument('--output_n', type=int, default=25, help='future frame number')  # 10为短时，25为长时
